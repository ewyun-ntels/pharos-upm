...
const CHART_COLOR_PALETTE: {[key: string]: string} = {
  chart_1:  'hsl(258, 90%, 66%, 0.8)', // #8B5CF6
  chart_2:  'hsl(216, 94%, 55%, 0.8)', // #2079F9
  chart_3:  'hsl(145, 60%, 47%, 0.8)', // #31BE6C
  chart_4:  'hsl(28, 80%, 52%, 0.8)',  // #E67E22
  chart_5:  'hsl(238, 77%, 65%, 0.8)', // #5D65EE
  chart_6:  'hsl(65, 100%, 42%, 0.8)', // #C9D700
  chart_7:  'hsl(44, 84%, 49%, 0.8)',  // #EBB00E
  chart_8:  'hsl(6, 78%, 57%, 0.8)',   // #E74C3C
  chart_9:  'hsl(167, 97%, 45%, 0.8)', // #03DCAD
  chart_10: 'hsl(87, 67%, 43%, 0.8)',  // #78B424
  chart_11: 'hsl(0, 54%, 41%, 0.8)',   // #A03030
  chart_12: 'hsl(204, 70%, 53%, 0.8)', // #3498DB
  chart_13: 'hsl(194, 77%, 60%, 0.8)', // #49C3EA
  chart_14: 'hsl(277, 44%, 41%, 0.8)', // #7D3C98
  chart_15: 'hsl(293, 64%, 54%, 0.8)', // #C743D7
  chart_16: 'hsl(146, 63%, 38%, 0.8)', // #239C56
  chart_17: 'hsl(229, 56%, 48%, 0.8)', // #3858C0
};
