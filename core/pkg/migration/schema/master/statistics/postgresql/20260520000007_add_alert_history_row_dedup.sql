-- +goose Up
ALTER TABLE history_alert_row ADD COLUMN IF NOT EXISTS evaluation_epoch BIGINT NULL;
...
ALTER TABLE history_alert_row DROP COLUMN IF EXISTS evaluation_epoch;
