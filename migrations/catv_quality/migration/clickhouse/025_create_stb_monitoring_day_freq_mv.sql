...
-- ========================================
-- mv_stb_monitoring_day_freq 생성
-- stb_monitoring에서 직접 일별 집계
-- ========================================
CREATE MATERIALIZED VIEW IF NOT EXISTS catv.mv_stb_monitoring_day_freq ON CLUSTER clickhouse_cluster
TO catv.stb_monitoring_day_freq
AS SELECT
...
-- +goose Down
-- +goose StatementBegin
DROP VIEW IF EXISTS catv.mv_stb_monitoring_day_freq ON CLUSTER clickhouse_cluster SYNC;
-- +goose StatementEnd
