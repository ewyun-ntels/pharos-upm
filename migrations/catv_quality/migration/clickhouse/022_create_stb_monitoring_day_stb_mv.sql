...
-- ========================================
-- mv_stb_monitoring_day_stb 생성
-- stb_monitoring에서 직접 일별 집계
-- ========================================
CREATE MATERIALIZED VIEW IF NOT EXISTS catv.mv_stb_monitoring_day_stb ON CLUSTER clickhouse_cluster
TO catv.stb_monitoring_day_stb
AS SELECT
...
-- +goose Down
-- +goose StatementBegin
DROP VIEW IF EXISTS catv.mv_stb_monitoring_day_stb ON CLUSTER clickhouse_cluster SYNC;
-- +goose StatementEnd
